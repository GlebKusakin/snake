...
function move() {
    ...
    for (let i = 0; i < snakeBody.length; i++) {
        snakeBody[i].classList.remove('down');
        snakeBody[i].classList.remove('up');
        snakeBody[i].classList.remove('right');
        snakeBody[i].classList.remove('left');
        snakeBody[i].classList.add('snakeBody');
        if(direction == 'down'){
        snakeBody[i].classList.add('down');
        }
        else if(direction=='up'){
            snakeBody[i].classList.add('up');
        }
        else if(direction=='left'){
            snakeBody[i].classList.add('left');
        }
        else if(direction=='right'){
            snakeBody[i].classList.add('right');       }
    }
}
